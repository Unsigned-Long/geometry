...
#pragma region global
  ...
  template <typename _Ty>
  bool isIntersect(const Point2<_Ty> &searchPoint,
                   const Point2<_Ty> &nodePoint,
                   float radius,
                   SplitFeature sf) {
    bool bl;
    switch (sf) {
  ...
  template <typename _Ty>
  bool isIntersect(const Point3<_Ty> &searchPoint,
                   const Point3<_Ty> &nodePoint,
                   float radius,
                   SplitFeature sf) {
    bool bl;
    switch (sf) {
...
#pragma region kdtree
  ...
  public:
     ...
     */
    void nearestKSearch(const point_type &searchPoint,
                        std::size_t K,
  ...
  protected:
     ...
     */
    virtual void sortPointSet(SplitFeature sf,
                              pointset_type &lps,
                              pointset_type &rps) = 0;

    void buildKdTree(node_ptr &np,
                     SplitFeature sf,
                     pointset_type lps,
                     pointset_type rps) {
  ...
  private:
    virtual void buildKdTree(pointset_type ps) override {
      ...
      if (stdevp_x < stdevp_y) {
        // split feature : Y
        std::sort(ps.begin(), ps.end(), [](const auto &p1, const auto &p2) { return p1.y() < p2.y(); });
        sf = SplitFeature::Y;
      } else {
        // split feature : X
        std::sort(ps.begin(), ps.end(), [](const auto &p1, const auto &p2) { return p1.x() < p2.x(); });
        sf = SplitFeature::X;
      }
    ...
    virtual void sortPointSet(SplitFeature sf,
      ...
      if (sf == SplitFeature::X) {
        std::sort(lps.begin(), lps.end(), [](const auto &p1, const auto &p2) { return p1.x() < p2.x(); });
        std::sort(rps.begin(), rps.end(), [](const auto &p1, const auto &p2) { return p1.x() < p2.x(); });
      } else {
        std::sort(lps.begin(), lps.end(), [](const auto &p1, const auto &p2) { return p1.y() < p2.y(); });
        std::sort(rps.begin(), rps.end(), [](const auto &p1, const auto &p2) { return p1.y() < p2.y(); });
      }
      return;
    }
  };
  ...
  private:
    virtual void buildKdTree(pointset_type ps) override {
      ...
      if (stdevp_x <= stdevp_y && stdevp_z <= stdevp_y) {
        ...
        // split feature : Z
        std::sort(ps.begin(), ps.end(), [](const auto &p1, const auto &p2) { return p1.z() < p2.z(); });
        sf = SplitFeature::Z;
      } else {
        // split feature : X
        std::sort(ps.begin(), ps.end(), [](const auto &p1, const auto &p2) { return p1.x() < p2.x(); });
    ...
    virtual void sortPointSet(SplitFeature sf,
      ...
      if (sf == SplitFeature::X) {
        ...
        std::sort(lps.begin(), lps.end(), [](const auto &p1, const auto &p2) { return p1.z() < p2.z(); });
        std::sort(rps.begin(), rps.end(), [](const auto &p1, const auto &p2) { return p1.z() < p2.z(); });
      }
      return;
    }
  };
...
#pragma region refkdtree2
  ...
  public:
     ...
     * @param dis the distance
     */
    void radiusSearch(const point_type &searchPoint,
                      float radius,
                      std::vector<refpoint_type> &ps,
                      std::vector<float> &dis) const {
