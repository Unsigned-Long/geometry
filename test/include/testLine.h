...
TEST(Line2f, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<std::array<ns_geo::Point2f, 2>, ns_geo::Line2f::ary_type>();
...
TEST(Line3f, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<std::array<ns_geo::Point3f, 2>, ns_geo::Line3f::ary_type>();
...
TEST_F(TestRefPointSet2f, RefLine2f_typeTesting)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::RefPoint2f, ns_geo::RefLine2f::refpoint_type>();
    testing::StaticAssertTypeEq<ns_geo::RefPointSet2f, ns_geo::RefLine2f::refpointset_type>();
    testing::StaticAssertTypeEq<std::array<ns_geo::RefPoint2f, 2>, ns_geo::RefLine2f::ary_type>();
    testing::StaticAssertTypeEq<ns_geo::RefLine2f, ns_geo::RefLine2f::self_type>();
}
...
TEST_F(TestRefPointSet3f, RefLine3f_typeTesting)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::RefPoint3f, ns_geo::RefLine3f::refpoint_type>();
    testing::StaticAssertTypeEq<ns_geo::RefPointSet3f, ns_geo::RefLine3f::refpointset_type>();
    testing::StaticAssertTypeEq<std::array<ns_geo::RefPoint3f, 2>, ns_geo::RefLine3f::ary_type>();
    testing::StaticAssertTypeEq<ns_geo::RefLine3f, ns_geo::RefLine3f::self_type>();
}