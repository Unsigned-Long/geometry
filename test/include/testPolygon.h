...
TEST_F(TestPointSet, polygonf_normalTestign)
{
    ...
    EXPECT_FLOAT_EQ(polygon.perimeter(), std::sqrt(2.0f) + 3.0f + std::sqrt(5.0f));
...
TEST_F(TestRefPointSet2f, refpolygonf_typeTestign)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::RefPoint2f, ns_geo::RefPolygonf::refpoint_type>();
    testing::StaticAssertTypeEq<std::vector<uint>, ns_geo::RefPolygonf::pointidset_type>();
    testing::StaticAssertTypeEq<ns_geo::RefPointSet2f, ns_geo::RefPolygonf::refpointset_type>();
    testing::StaticAssertTypeEq<ns_geo::RefPolygonf, ns_geo::RefPolygonf::self_type>();
}
