...
TEST_F(TestPointSet, LineString2f_typeTesting) {
  ...
  testing::StaticAssertTypeEq<ns_geo::PointSet2f,
                              ns_geo::LineString2f::pointset_type>();
  testing::StaticAssertTypeEq<ns_geo::LineString2f,
                              ns_geo::LineString2f::self_type>();
}
...
TEST_F(TestPointSet, LineString3f_typeTesting) {
  ...
  testing::StaticAssertTypeEq<ns_geo::PointSet3f,
                              ns_geo::LineString3f::pointset_type>();
  testing::StaticAssertTypeEq<ns_geo::LineString3f,
                              ns_geo::LineString3f::self_type>();
}
...
TEST_F(TestRefPointSet2f, RefLineString2f_typeTesting) {
  ...
  testing::StaticAssertTypeEq<ns_geo::RefPoint2f,
                              ns_geo::RefLineString2f::refpoint_type>();
  testing::StaticAssertTypeEq<std::vector<uint>,
                              ns_geo::RefLineString2f::pointidset_type>();
  testing::StaticAssertTypeEq<ns_geo::RefPointSet2f,
                              ns_geo::RefLineString2f::refpointset_type>();
  testing::StaticAssertTypeEq<ns_geo::RefLineString2f,
                              ns_geo::RefLineString2f::self_type>();
}
...
TEST_F(TestRefPointSet3f, RefLineString3f_typeTesting) {
  ...
  testing::StaticAssertTypeEq<ns_geo::RefPoint3f,
                              ns_geo::RefLineString3f::refpoint_type>();
  testing::StaticAssertTypeEq<std::vector<uint>,
                              ns_geo::RefLineString3f::pointidset_type>();
  testing::StaticAssertTypeEq<ns_geo::RefPointSet3f,
                              ns_geo::RefLineString3f::refpointset_type>();
