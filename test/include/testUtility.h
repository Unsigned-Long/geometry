...
TEST_F(TestPointSet, utility_RHandRule) {
  ...
  test_point2f_eq(ns_geo::RHandRule::polarCoorMap(p1, std::sqrt(2.0f), M_PI_4),
                  {1.0f, 3.0f});
  test_point3f_eq(
      ns_geo::RHandRule::polarCoorMap(p3, std::sqrt(2.0f), M_PI_4, M_PI_2),
      {1.0f, 3.0f, 1.0f});
}
...
TEST_F(TestPointSet, utility_LHandRule) {
  ...
  test_point2f_eq(ns_geo::LHandRule::polarCoorMap(p1, std::sqrt(2.0f), M_PI_4),
                  {1.0f, 3.0f});
  test_point3f_eq(
