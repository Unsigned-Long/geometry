...
TEST(Rectanglef, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::Point2f, ns_geo::Rectanglef::point_type>();
    testing::StaticAssertTypeEq<std::array<ns_geo::Point2f, 2>, ns_geo::Rectanglef::ary_type>();
    testing::StaticAssertTypeEq<ns_geo::Rectanglef, ns_geo::Rectanglef::self_type>();
}
...
TEST_F(TestRefPointSet2f, refrectangle_typeTesting)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::RefPoint2f, ns_geo::RefRectanglef::refpoint_type>();
    testing::StaticAssertTypeEq<ns_geo::RefPointSet2f, ns_geo::RefRectanglef::refpointset_type>();
    testing::StaticAssertTypeEq<std::array<ns_geo::RefPoint2f, 2>, ns_geo::RefRectanglef::ary_type>();
    testing::StaticAssertTypeEq<ns_geo::RefRectanglef, ns_geo::RefRectanglef::self_type>();
}
