...
TEST(PointSet2f, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::Point2f, ns_geo::PointSet2f::point_type>();
    testing::StaticAssertTypeEq<std::vector<ns_geo::Point2f>, ns_geo::PointSet2f::container_type>();
}
...
TEST(PointSet3f, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::Point3f, ns_geo::PointSet3f::point_type>();
    testing::StaticAssertTypeEq<std::vector<ns_geo::Point3f>, ns_geo::PointSet3f::container_type>();
}
...
TEST(RefPoint2f, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<std::array<float, 2>, ns_geo::RefPoint2f::ary_type>();
    testing::StaticAssertTypeEq<ns_geo::RefPoint2f, ns_geo::RefPoint2f::self_type>();
}

TEST(RefPoint3f, normalTesting)
{
    const ns_geo::RefPoint3d p1(0, ns_geo::RefPoint3d::ary_type{0.0f, 0.0f, 0.0f});
...
TEST(RefPoint3f, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<std::array<float, 3>, ns_geo::RefPoint3f::ary_type>();
    testing::StaticAssertTypeEq<ns_geo::RefPoint3f, ns_geo::RefPoint3f::self_type>();
}
...
TEST(RefPointSet2f, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::RefPoint2f, ns_geo::RefPointSet2f::refpoint_type>();
    testing::StaticAssertTypeEq<uint, ns_geo::RefPointSet2f::id_type>();
    testing::StaticAssertTypeEq<std::unordered_map<uint, ns_geo::RefPoint2f>, ns_geo::RefPointSet2f::container_type>();
}
...
TEST(RefPointSet3f, typeTesting)
{
    ...
    testing::StaticAssertTypeEq<ns_geo::RefPoint3f, ns_geo::RefPointSet3f::refpoint_type>();
    testing::StaticAssertTypeEq<uint, ns_geo::RefPointSet3f::id_type>();
    testing::StaticAssertTypeEq<std::unordered_map<uint, ns_geo::RefPoint3f>, ns_geo::RefPointSet3f::container_type>();
}
